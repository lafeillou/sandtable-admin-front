    ...
    <div class="weather-area">
      <div class="weather-info">
        <a-card :loading="loading" :title="this.weather.countyName + ' 当前天气'">
          <a-row>
            <a-col :span="8">
              <p>天气：{{this.weather.realtime.weather}}</p>
            </a-col>
            <a-col :span="8">
              <p>风向：{{this.weather.realtime.wD}}</p>
            </a-col>
            <a-col :span="8">
              <p>风力大小：{{this.weather.realtime.wS}}</p>
            </a-col>
          </a-row>
          <a-row>
            <a-col :span="8">
              <p>温度：{{this.weather.realtime.temp}}℃</p>
            </a-col>
            <a-col :span="8">
              <p>体感温度：{{this.weather.realtime.sendibleTemp}}℃</p>
            </a-col>
            <a-col :span="8">
              <p>空气湿度：{{this.weather.realtime.sD}}%</p>
            </a-col>
          </a-row>
          <a-row>
            <a-col :span="8">
              <p>更新时间：{{this.weather.realtime.time}}</p>
            </a-col>
          </a-row>
        </a-card>
      </div>
  ...
  methods: {
    ...
    searchWeather() {
      if (!this.areaId) {
        ...
        this.$get('weather?areaId=' + this.areaId)
          .then(r => {
