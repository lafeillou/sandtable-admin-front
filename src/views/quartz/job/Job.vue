    ...
    <div :class="advanced ? 'search' : null">
      <a-form layout="horizontal">
        <div :class="advanced ? null: 'fold'">
          <a-row>
            <a-col :md="12" :sm="24">
              <a-form-item label="Bean名称" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.beanName" />
              </a-form-item>
            </a-col>
            <a-col :md="12" :sm="24">
              <a-form-item label="方法名称" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
          ...
          <a-row v-if="advanced">
            <a-col :md="12" :sm="24">
              <a-form-item label="方法参数" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.params" />
              </a-form-item>
            </a-col>
            <a-col :md="12" :sm="24">
              <a-form-item label="执行时间" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
    ...
    <div>
      ...
      >
        ...
        <template slot="operations" slot-scope="text, record">
          ...
          <a-badge
            v-hasNoPermission="['job:update','job:run','job:pause','job:resume']"
            status="warning"
            text="无权限"
          ></a-badge>
        </template>
