  ...
  <a-card :bordered="false" class="card-area">
    <a-form layout="horizontal">
      <div :class="advanced ? null: 'fold'">
        <a-row>
          <a-col :md="12" :sm="24">
            <a-form-item label="操作人" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
              <a-input v-model="queryParams.username" />
            </a-form-item>
          </a-col>
          <a-col :md="12" :sm="24">
            <a-form-item label="操作描述" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
        ...
        <a-row v-if="advanced">
          <a-col :md="12" :sm="24">
            <a-form-item label="操作地点" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
