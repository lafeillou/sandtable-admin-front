    ...
    <div :class="advanced ? 'search' : null">
      <a-form layout="horizontal">
        <div :class="advanced ? null: 'fold'">
          <a-row>
            <a-col :md="8" :sm="24">
              <a-form-item label="键" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.keyy" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="值" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.valuee" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="表名" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
          ...
          <a-row v-if="advanced">
            <a-col :md="8" :sm="24">
              <a-form-item label="字段" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
