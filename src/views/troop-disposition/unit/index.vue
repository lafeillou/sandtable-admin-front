<template>
  <a-card :bordered="false" class="card-area">
    ...
    <div>
      <div class="operator">
        ...
        <a-upload
          ...
          :headers="headers"
          :action="baseURL + '/api/v1/sandtable-contingent/batch_insert'"
          accept=".xls, .xlsx"
    ...
    <unit-add @success="handleAddSuccess" @close="handleAddClose" :addVisiable="addVisiable"></unit-add>
    <unit-edit
      ref="editDialog"
  ...
  computed: {
    ...
    columns() {
      ...
      return [
        ...
        {
          title: '分队类型',
          dataIndex: 'contingentType'
        },
        {
          title: '所属行政区',
          dataIndex: 'contingentDesc'
        },
        {
          title: '负责人',
          dataIndex: 'contingentCaptain'
        },
        {
          title: '负责人联系电话',
          dataIndex: 'captainTelephone'
        },
        {
          title: '省份',
          dataIndex: 'contingentProvince'
        },
        {
          title: '市区',
          dataIndex: 'contingentCity'
        },
        {
          title: '区县',
          dataIndex: 'contingentDistrict'
        },
        {
          title: '详细地址',
          dataIndex: 'contingentAddress'
        },
        {
          title: '操作',
          dataIndex: 'operation',
    ...
    batchDelete() {
      ...
      this.$confirm({
        ...
        onOk() {
          ...
          that.$delete('/api/v1/sandtable-contingent/' + ids.join(',')).then(() => {
